...
window.addEventListener('load', function () {
    section[0].style.backgroundPositionY = `-${
        scrolled().scrollPosition * 3
    }px`;
    section[1].style.backgroundPositionY = `${
        scrolled().scrollPosition * 3 - 200
    }px`;
    section[2].style.backgroundPositionY = `-${
